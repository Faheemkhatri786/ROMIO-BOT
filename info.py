...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1321078922 5281368582 1667340007').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002076445387')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://faheem:faheem@faheemansari.ljh4xay.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "faheemansari")
...
URL = "https://significant-tiger-sameer786-7de06c4b.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://significant-tiger-sameer786-7de06c4b.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://significant-tiger-sameer786-7de06c4b.koyeb.app/".format(FQDN)
else:
    URL = "https://significant-tiger-sameer786-7de06c4b.koyeb.app/".format(FQDN)
